...
async function grabData(coords)
{
    ...
    try
    {	
		// these keys are for the free version of this api. idc if they are exposed.
		let bundle = {};
		let currentCall = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=imperial&APPID=aabf36730a708b7894baf8a391a30caf`;
		...
		let forecastCall = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&units=imperial&APPID=aabf36730a708b7894baf8a391a30caf`;
